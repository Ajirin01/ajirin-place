...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  <div class="wrapper">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            @can('isShopAssist')
              ...
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{ route('admin.preorder.create') }}" class="nav-link text-warning">
                      <i class="far fa-circle nav-icon"></i>
                      <p>New Order</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ route('admin.preorder.index') }}" class="nav-link text-success">
                      <i class="far fa-circle nav-icon"></i>
                      <p>All Pre-Orders</p>
                    </a>
                  </li>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2014-2020 <a href="https://ajirinplace.com.ng">Ajirinibi Web Solution</a>.</strong>
      All rights reserved.
